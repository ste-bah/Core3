...
rebelRewardData = {
	...
	hirelingList = {
		...
		"specforce_procurement_specialist", "specforce_technician",	"specforce_wilderness_operative", "rebel_specforce_guerrilla", "rebel_battle_droid",
	},
	...
	hirelings = {
		...
		rebel_battle_droid = { type=factionRewardType.hireling, display="@mob/creature_names:rebel_battle_droid", item="object/intangible/pet/pet_control.iff", controlledObjectTemplate="rebel_battle_droid", cost=9500},
	}
}
