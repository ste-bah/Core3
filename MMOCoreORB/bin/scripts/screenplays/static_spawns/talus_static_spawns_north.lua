...
function TalusStaticSpawnsNorthScreenPlay:spawnMobiles()
	...
	--Dath Tree (-55,980)
	spawnMobile("talus", "greater_sludge_panther", 360, -71.0, 16.9, 982.6, 2, 0)

	--Tent and Skeletons (86,1581)
	spawnMobile("talus", "rotting_decay_mite_guard", 360, 82.6, 11.6, 1584.5, 80, 0)

	--Pillar (618,1100)
	spawnMobile("talus", "aakuan_sentinel", 60, 621.4, 41.2, 1098.0, -3, 0)
	...
	spawnMobile("talus", "aakuan_keeper", 60, 2466.3, 34.2, 787.7, 106, 0)
	spawnMobile("talus", "aakuan_keeper", 60, 2472.9, 33.1, 791.7, -150, 0)
	spawnMobile("talus", "aakuan_champion", 60, 2469.4, 30.3, 810.6, 177, 0)
	...
	spawnMobile("talus", "aakuan_guardian", 360, -5098.3, 47.5, 2362.4, 75, 0)
