...
function GalacticTravelToTheedScreenPlay:spawnMobiles()
  -- Spawn our pilots
  local pPilotCorellia = spawnMobile("corellia", "star_pilot_to_theed", 1, -59, 28, -4715, 0, 0)
  local pPilotCorellia = spawnMobile("corellia", "star_pilot_to_theed", 1, -4992, 21, -2229, 0, 0)
  local pPilotCorellia = spawnMobile("corellia", "star_pilot_to_theed", 1, -3147, 31, 2879, 0, 0)
  local pPilotCorellia = spawnMobile("corellia", "star_pilot_to_theed", 1, -3357, 308, 5595, 0, 0)
  local pPilotDantooine = spawnMobile("dantooine", "star_pilot_to_theed", 1, -642.662, 3, 2486.08, 42, 0)
  local pPilotDantooine = spawnMobile("dantooine", "star_pilot_to_theed", 1, 1586, 4, -6408, 42, 0)
  local pPilotDantooine = spawnMobile("dantooine", "star_pilot_to_theed", 1, -4227, 3, -2357, 42, 0)
  local pPilotDathomir = spawnMobile("dathomir", "star_pilot_to_theed", 1, 597.006, 6, 3095.09, 115, 0)
  local pPilotDathomir = spawnMobile("dathomir", "star_pilot_to_theed", 1, -72, 18, -1475, 115, 0)
  local pPilotEndor = spawnMobile("endor", "star_pilot_to_theed", 1, -972.542, 73, 1560.99, 123, 0)
  local pPilotEndor = spawnMobile("endor", "star_pilot_to_theed", 1, 3219, 24, -3491, 123, 0)
  ...
  local pPilotRori = spawnMobile("rori", "star_pilot_to_theed", 1, 5351, 80, 5735, 0, 0)
  local pPilotRori = spawnMobile("rori", "star_pilot_to_theed", 1, 3673, 80, -6411, 0, 0)
  local pPilotTalus = spawnMobile("talus", "star_pilot_to_theed", 1, 233.395, 6, -2940.64, 0, 0)
  local pPilotTalus = spawnMobile("talus", "star_pilot_to_theed", 1, 4457, 2, 5356, 0, 0)
  local pPilotTalus = spawnMobile("talus", "star_pilot_to_theed", 1, -2221, 20, 2303, 0, 0)
  local pPilotTatooine = spawnMobile("tatooine", "star_pilot_to_theed", 1, 3631.17, 5, -4791.17, 0, 0)
  local pPilotTatooine = spawnMobile("tatooine", "star_pilot_to_theed", 1, -1365, 12, -3588, 0, 0)
  local pPilotTatooine = spawnMobile("tatooine", "star_pilot_to_theed", 1, -2833, 5, 2096, 0, 0)
  local pPilotTatooine = spawnMobile("tatooine", "star_pilot_to_theed", 1, 1261, 7, 3062, 0, 0)
  local pPilotYavin = spawnMobile("yavin4", "star_pilot_to_theed", 1, -6931.51, 73, -5701.57, -46, 0)  
  local pPilotYavin = spawnMobile("yavin4", "star_pilot_to_theed", 1, -286, 35, 4888, -46, 0)
  local pPilotYavin = spawnMobile("yavin4", "star_pilot_to_theed", 1, 4034, 37, -6224, -46, 0)
end
